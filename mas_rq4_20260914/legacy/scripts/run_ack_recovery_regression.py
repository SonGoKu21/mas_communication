...
Identity, request budgets and off-peak enforcement use the shared Flash runner.
"""
...
def run_regression(args):
    ...
    with runner.locked_workflow():
        ...
        with runner.locked_output(args.output_dir):
            ...
            summary = runner.write_reports(args.output_dir, config["jobs"], state, scheduler_stop=stop)
            if stop is None:
